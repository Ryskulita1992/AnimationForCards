...
struct ContentView: View {
    ...
    var body: some View {
        ZStack{
            Color(#colorLiteral(red: 0.8948933482, green: 0.611137569, blue: 0.6723880172, alpha: 1))
            ...
            VStack{
                ...
                ZStack{
                    Image(uiImage: #imageLiteral(resourceName: "card 1"))
                    ...
                    Image( uiImage: #imageLiteral(resourceName: "card 2"))
